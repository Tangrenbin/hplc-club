...
<div class="home-shell">
    ...
    <div class="hero__grid">
      <div class="hero__main">
        ...
        <div class="hero__actions">
          <a class="hero__button hero__button--primary" href="#all-posts">查看全部稿件 →</a>
  ...
  <section id="all-posts">
    <h2 class="section-title">全部稿件</h2>
    <p class="section-lead">
      当前公开稿件统一收录在这里，点击卡片可直接进入对应页面。
    </p>

    <div class="chapter-grid">
      <article class="chapter-card">
        <a href="辽宁26年1批送检记录/">
          <span class="chapter-card__tag">送检记录</span>
          <h3>辽宁26年1批送检记录</h3>
          <p>辽宁区域 2026 年第 1 批送检记录汇总。</p>
        </a>
      </article>
